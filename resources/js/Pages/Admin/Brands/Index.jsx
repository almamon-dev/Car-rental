                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[12px] text-[#00000099] mt-0.5 font-medium">
                                    Manage vehicle manufacturers and identities
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-9 space-y-4">
                        ...
                        <div className="bg-white rounded-lg border border-[#EBEBEB] p-2.5 flex items-center gap-3 shadow-sm">
                            <div className="flex-1 relative group">
                                <BadgeCheck className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#0a66c2] transition-colors" size={14} />
                                <input 
                                    type="text"
                                    value={search}
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead className="bg-[#fbfeff] border-b border-[#f3f2ef]">
                                        <tr>
                                            ...
                                            <th className="py-3 px-4 text-[11px] font-bold text-[#00000099] uppercase tracking-wider">Logo</th>
                    ...
                    <div className="lg:col-span-3 space-y-4 sticky top-4">
                        <div className="bg-white rounded-lg border border-[#EBEBEB] shadow-sm p-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-[12px] text-gray-500 font-medium">Total Brands</span>
                                    <span className="text-[13px] font-bold text-gray-900">{counts.all || 0}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-[12px] text-gray-500 font-medium">Active</span>
                        ...
                        <div className="bg-[#f3f6f8] rounded-lg border border-[#EBEBEB] p-4">
                             <p className="text-[11px] text-[#00000099] leading-relaxed">
                                 <strong>Tip:</strong> Ensure accurate brand logos to enable correct vehicle filtering for customers.
                             </p>
                        </div>
