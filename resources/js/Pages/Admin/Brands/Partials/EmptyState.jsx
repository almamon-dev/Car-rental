    ...
    return (
        <div className="flex flex-col items-center justify-center py-20 px-6 bg-white">
            ...
            <h3 className="text-[18px] font-semibold text-gray-900 mb-1 tracking-tight">
                {hasActiveFilters ? "No matching brands" : "Brand directory is empty"}
            </h3>
            
            <p className="max-w-[360px] text-[14px] text-gray-500 mb-8 leading-normal font-sans text-center">
                {hasActiveFilters 
                    ? "Try adjusting your search filters to find the specific manufacturer." 
                    : "Start populating your catalog by adding your first vehicle manufacturer brand."}
            </p>
            ...
            <div className="flex items-center gap-3">
                {hasActiveFilters ? (
                    ...
                    <a
                        ...
                        className="px-8 py-2 text-[14px] font-semibold text-white bg-[#0a66c2] rounded-full hover:bg-[#004182] transition-all"
                    >
                        Add brand
                    </a>
                )}
