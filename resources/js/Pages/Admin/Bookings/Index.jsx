 ...
 * 
 * Manages the collection of car rental bookings.
 * Tracks customer details, rental dates, vehicle info, and payment status.
 * 
 * @author AL Mamon
 * @version 1.2.0
 */
...
export default function BookingIndex({ auth, bookings, stats, filters = {} }) {
    ...
    return (
        <AdminLayout user={auth.user}>
            <Head title="Bookings | Admin Panel" />
                    ...
                    <div className="px-8 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
                        <div className="flex items-center gap-5">
                            ...
                            <div className="space-y-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[12px] font-bold text-[#0a66c2]">Reservation System</span>
                                </div>
                                <h1 className="text-2xl font-bold text-slate-800 tracking-tight">
                                    Car Bookings
                                </h1>
                                <p className="text-[14px] text-slate-500 font-medium italic">
                                    View and manage all active, pending, and completed car rental reservations.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            <button 
                                ...
                                className="h-11 px-6 bg-[#0a66c2] hover:bg-[#084d92] text-white rounded-xl font-bold text-[13px] transition-all flex items-center gap-2 shadow-md shadow-[#0a66c2]/10"
                            >
                                <Download size={18} />
                                Export Bookings
                            </button>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead className="bg-[#f8fbff] border-b border-slate-100">
                                        <tr>
                                            ...
                                            <th className="py-4 px-4 text-[12px] font-bold text-slate-500 uppercase tracking-wider">Booking ID</th>
                                            <th className="py-4 px-4 text-[12px] font-bold text-slate-500 uppercase tracking-wider">Customer</th>
                                            <th className="py-4 px-4 text-[12px] font-bold text-slate-500 uppercase tracking-wider">Vehicle</th>
                                            <th className="py-4 px-4 text-[12px] font-bold text-slate-500 uppercase tracking-wider">Dates</th>
                                            <th className="py-4 px-4 text-[12px] font-bold text-slate-500 uppercase tracking-wider">Amount</th>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <span className="text-[13px] text-slate-500 font-semibold">Total Bookings</span>
                                    <span className="text-[15px] font-bold text-slate-900">{stats.total}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-[13px] text-slate-500 font-semibold">Pending</span>
                                    <span className="text-[15px] font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-lg">{stats.pending}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-[13px] text-slate-500 font-semibold">Confirmed</span>
                                    <span className="text-[15px] font-bold text-[#0a66c2] bg-blue-50 px-2 py-0.5 rounded-lg">{stats.confirmed}</span>
                                </div>
                                ...
                                <div className="pt-1 flex items-center gap-3">
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-[11px] font-bold text-slate-400 uppercase">Gross Revenue</p>
                                        <p className="text-[14px] font-bold text-emerald-600">৳{stats.total_revenue?.toLocaleString()}</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <div className="bg-slate-900 rounded-xl shadow-lg p-6 relative overflow-hidden">
                            <div className="relative z-10">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-[11px] font-bold text-[#0a66c2]">Insight</span>
                                </div>
                                <h4 className="text-white font-bold text-lg mb-2">Revenue Tracking</h4>
                                <p className="text-slate-400 text-[13px] mb-5 font-medium leading-relaxed italic">
                                    "Keeping your booking status updated ensures accurate revenue reporting and better car availability management."
                                </p>
                            </div>
                            <Briefcase size={120} className="absolute -right-10 -bottom-10 text-white/[0.03] rotate-12" />
                        </div>

                         <div className="pt-4 text-center">
                             <span className="text-[11px] font-bold text-slate-300 uppercase tracking-widest block border-t border-slate-50 pt-4">Booking System © 2026</span>
                         </div>
                    </div>
                </div>
            </div>
