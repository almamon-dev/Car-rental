...
// pricingData removed from here, now using translations from context
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex items-center justify-between mb-10 border-b border-gray-100 pb-5">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-[10px] font-bold text-[#0a66c2] uppercase tracking-[0.2em]">{t.home.pricing.arch}</span>
                        </div>
                        <h2 className="text-[22px] font-bold text-[#000000e6] tracking-tight">
                            {t.home.pricing.title}
                        </h2>
                        <p className="text-[12.5px] text-gray-500 mt-1 font-medium italic">{t.home.pricing.subtitle}</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {t.home.pricing.plans.map((plan, index) => {
                        const isRecommended = index === 1; // Executive Plan
                        const tierId = index === 0 ? "Tier 1" : index === 1 ? "Tier 2" : index === 2 ? "Tier 3" : "Vault";
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <span className="text-[10px] font-black text-[#0a66c2] uppercase tracking-[0.2em]">{tierId}</span>
                                    {isRecommended && (
                                        <div className="flex items-center gap-1 bg-blue-50 px-2 py-0.5 rounded-md">
                                            <ShieldCheck size={10} className="text-[#0a66c2]" />
                                            <span className="text-[9px] font-black text-[#0a66c2] uppercase">{t.home.pricing.recommended}</span>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="mb-6">
                                    ...
                                    <p className="text-[12px] text-gray-400 font-medium leading-snug line-clamp-2">{plan.desc}</p>
                                </div>
                                ...
                                <div className="mb-8">
                                    <div className="flex items-baseline gap-1">
                                        ...
                                        {price !== "Contact" && (
                                            <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest leading-none">{t.home.pricing.per_30_days}</span>
                                        )}
                                    </div>
                                </div>
                ...
                <div className="mt-8 py-4 px-6 bg-slate-100/50 rounded-[12px] border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
                     <div className="flex items-center gap-4">
                         ...
                         <p className="text-[11px] font-bold text-gray-500 uppercase tracking-widest">{t.home.pricing.joined_by}</p>
                     </div>
