 ...
 * 
 * Displays a responsive, interactive slider showcasing car categories.
 * Integrates with Swiper for touch-enabled navigation and Inertia.js for seamless routing.
 * 
 * @author AL Mamon
 * @version 1.0.0
 */
 ...
 * 
 * @param {Object} props
 * @param {Array} props.categories - List of category objects (name, slug, icon, cars_count)
 * @returns {JSX.Element}
 */
export default function CategorySlider({ categories = [] }) {
    ...
    /**
     * Simulated loading delay to maintain UI stability during hydration
     */
    useEffect(() => {
    ...
    return (
        <section className="w-full bg-transparent py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                {/* --- Main Content Area: Swiper Integration --- */}
                <div className="relative group/swiper overflow-hidden">
                    {isLoading ? (
                        ...
                        /* Real State: Dynamic Swiper Carousel */
                        <Swiper
                            ...
                            onSwiper={(swiper) => {
                                // Manual initialization for dynamic ref connection
